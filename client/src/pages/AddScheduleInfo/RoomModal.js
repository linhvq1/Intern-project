...
function RoomModal({commonStore}) {
  ...
  return (
    <Modal closable={false} open={commonStore.isShowRoomModal} width={900} 
        footer={false}
    >
        <Form
            labelCol={{
        ...
        >
            ...
            <Row>
                <Col span={4}></Col>
                <Col span={20}><Button className='bg-gray-500 text-white'>検索</Button></Col>
            </Row>
        </Form>
        <CustomTable columns={columns} styles={"mt-4"} sumable={false} dataSource={data} key={'room_id'}/>
